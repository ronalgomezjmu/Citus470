...
#define CONFIGURE_ARGS " '--prefix=/scratch/postgres-citus/local' '--with-readline' '--with-zlib' 'LDFLAGS=-L/scratch/postgres-citus/local/lib -Wl,-rpath=/scratch/postgres-citus/local/lib' 'CPPFLAGS=-I/scratch/postgres-citus/local/include' 'PKG_CONFIG_PATH=/scratch/postgres-citus/local/lib/pkgconfig' 'LIBS=-lreadline -lncurses'"
...
#define PG_VERSION_STR "PostgreSQL 16.0 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 8.5.0 20210514 (Red Hat 8.5.0-22), 64-bit"
